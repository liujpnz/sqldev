...
select * from dwdb.dbo.Salesorder

--add columns
alter table dwdb.dbo.salesorder add importTxnid varchar(36);
alter table dwdb.dbo.invoice add importTxnid varchar(36);
alter table dwdb.dbo.invoice alter column refnumber varchar(50);
alter table dwdb.dbo.invoiceline alter column refnumber varchar(50);
...
--disable trigger
ALTER TABLE [dwdb].[dbo].[Salesorder] DISABLE TRIGGER [Salesorder_AutoGenerateRefnumber];
ALTER TABLE [dwdb].[dbo].[Salesorder] DISABLE TRIGGER [AutoSalesorder_TimeModified];

ALTER TABLE [dwdb].[dbo].[Invoice] DISABLE TRIGGER [Invoice_AutoGenerateRefnumber];
ALTER TABLE [dwdb].[dbo].[Invoice] DISABLE TRIGGER [AutoInvoice_TimeModified];

ALTER TABLE [dwdb].[dbo].[Invoiceline] DISABLE TRIGGER [AutoInvoiceline_TimeModified];

ALTER TABLE [dwdb].[dbo].[Salesorderline] DISABLE TRIGGER [AutoSalesorderline_TimeModified];



--insert into salesorder
select top 5 * from dwdb.dbo.Salesorder;
...
select top 5 TimeCreated,TimeModified,TxnDate,RefNumber,BillAddressLine1,SalesRepRefFullName,Subtotal,TotalAmount,IsFullyInvoiced from dwdb.dbo.Salesorder;
...
select * from dwdb.dbo.Salesorder where id<0
go

--insert invoice with new id
select top 5 * from  Dwdb.dbo.Invoice;
...
select * from dwdb.dbo.invoice where id<0



--insert salesorderline details with new salesorderid and refnumber
select top 5 * from dwdb.dbo.Salesorder;
select top 5 * from dwdb.dbo.Salesorderline;
select top 5 SalesOrderLineItemRefFullName,sku from DataCenter_Local.dbo.SalesOrderLine;
select RefNumber,salesorderid,SalesOrderLineSeqID ,SalesOrderLineItemRefFullName,TimeCreated,TimeModified,SalesOrderLineQuantity,SalesOrderLineRate,SalesOrderLineAmount,Store from dwdb.dbo.Salesorderline
select top 5 s.RefNumber,s.id,hl.SalesOrderLineSeqNo,hl.sku,hl.TimeCreated,hl.TimeModified,hl.SalesOrderLineQuantity,hl.SalesOrderLineRate,hl.SalesOrderLineAmount,'auckland' from DataCenter_Local.dbo.SalesOrderLine hl, dwdb.dbo.Salesorder s
where s.importTxnid=hl.TxnID;

--insert
insert into dwdb.dbo.Salesorderline (TimeCreated,TimeModified,RefNumber,SalesOrderLineSeqID,SalesOrderLineItemRefListID,SalesOrderLineItemRefFullName,SalesOrderlinedesc,SalesOrderLineQuantity,SalesOrderLineOldRate,SalesOrderLineRate,SalesOrderLineAmount,SalesOrderLineTaxAmount,SalesOrderLineInvoiced,SalesOrderLinePrepareToInvoiceQuantity,SalesorderID,DiscountPercentage,DiscountAmount,IsManuallyClosed,Store)
select hl.TimeCreated,hl.TimeModified,s.RefNumber,hl.SalesOrderLineSeqNo,hl.SalesOrderLineItemRefListID,hl.sku,hl.SalesOrderLineItemRefFullName,hl.SalesOrderLineQuantity,hl.SalesOrderLineRate,hl.SalesOrderLineRate,hl.SalesOrderLineAmount,hl.salestaxtotal,hl.SalesOrderLineQuantity,0,s.id,0,0,0,'auckland' from DataCenter_Local.dbo.SalesOrderLine hl, dwdb.dbo.Salesorder s
where s.importTxnid=hl.TxnID;


SELECT TimeCreated,TimeModified,RefNumber,SalesOrderLineSeqID,SalesOrderLineItemRefListID,SalesOrderLineItemRefFullName,SalesOrderlinedesc,SalesOrderLineQuantity,SalesOrderLineOldRate,SalesOrderLineRate,SalesOrderLineAmount,SalesOrderLineTaxAmount,SalesOrderLineInvoiced,SalesOrderLinePrepareToInvoiceQuantity,SalesorderID,DiscountPercentage,DiscountAmount,IsManuallyClosed,Store FROM Dwdb.dbo.Salesorderline
...
select id,RefNumber,salesorderid,SalesOrderLineSeqID ,SalesOrderLineItemRefFullName,TimeCreated,TimeModified,SalesOrderLineQuantity,SalesOrderLineRate,SalesOrderLineAmount,Store from dwdb.dbo.Salesorderline where id<0;

--insert invoiceline details
select top 5 * from dwdb.dbo.Invoice;
select top 5 * from dwdb.dbo.Invoiceline;
select top 5  * from DataCenter_Local.dbo.InvoiceLine;

select TimeCreated,TimeModified,RefNumber,InvoiceLineSeqID,InvoiceLineQuantity,InvoiceLineRate,InvoiceLineAmount,InvoiceID,Store from dwdb.dbo.Invoiceline;
select hl.TimeCreated,hl.TimeModified,i.RefNumber,hl.InvoiceLineSeqNo,hl.InvoiceLineQuantity,hl.InvoiceLineRate,hl.InvoiceLineAmount,i.id,'auckland' from DataCenter_Local.dbo.InvoiceLine hl, dwdb.dbo.Invoice i
where i.importTxnid=hl.TxnID

--insert
insert into dwdb.dbo.Invoiceline(TimeCreated,TimeModified,RefNumber,InvoiceLineSeqID,InvoiceLineItemFullName,InvoiceLineQuantity,InvoiceLineRate,InvoiceLineAmount,InvoiceLineTaxAmount,InvoiceID,InvoiceLineOldRate,DiscountPercentage,DiscountAmount,Memo,Store) 
select hl.TimeCreated,hl.TimeModified,i.RefNumber,hl.InvoiceLineSeqNo,hl.InvoiceLineItemRefFullName,hl.InvoiceLineQuantity,hl.InvoiceLineRate,hl.InvoiceLineAmount,hl.salestaxtotal,i.id,hl.InvoiceLineRate,0,0,hl.Memo,'auckland' from DataCenter_Local.dbo.InvoiceLine hl, dwdb.dbo.Invoice i
where i.importTxnid=hl.TxnID


SELECT TimeCreated,TimeModified,RefNumber,InvoiceLineSeqID,InvoiceLineItemFullName,InvoiceLineQuantity,InvoiceLineRate,InvoiceLineAmount,InvoiceLineTaxAmount,InvoiceID,InvoiceLineOldRate,DiscountPercentage,DiscountAmount,Memo,Store  FROM Dwdb.dbo.Invoiceline
...
select count(*) from dwdb.dbo.invoiceline where id<0
  

select count(*) from dwdb.dbo.Invoice
...
--enable trigger
ALTER TABLE [dwdb].[dbo].[Salesorder] ENABLE TRIGGER [Salesorder_AutoGenerateRefnumber];
ALTER TABLE [dwdb].[dbo].[Salesorder] ENABLE TRIGGER [AutoSalesorder_TimeModified];

ALTER TABLE [dwdb].[dbo].[Invoice] ENABLE TRIGGER [Invoice_AutoGenerateRefnumber];
ALTER TABLE [dwdb].[dbo].[Invoice] ENABLE TRIGGER [AutoInvoice_TimeModified];

ALTER TABLE [dwdb].[dbo].[Invoiceline] ENABLE TRIGGER [AutoInvoiceline_TimeModified];

ALTER TABLE [dwdb].[dbo].[Salesorderline] ENABLE TRIGGER [AutoSalesorderline_TimeModified];


--delete inserted data
delete dwdb.dbo.Salesorder where id<0
delete dwdb.dbo.Salesorderline where id<0
delete dwdb.dbo.Invoice where id<0
delete dwdb.dbo.Invoiceline where id<0
